  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4 pt-24">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="mt-6 text-2xl font-bold text-text-primary">Failed to Load Quizzes</h1>
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          ...
          <Link href="/quiz" className="inline-flex items-center gap-2 rounded-xl border border-border bg-white px-5 py-2.5 text-sm font-medium text-text-secondary hover:bg-surface-hover">
            Back to Quizzes
          </Link>
        </div>
      </div>
